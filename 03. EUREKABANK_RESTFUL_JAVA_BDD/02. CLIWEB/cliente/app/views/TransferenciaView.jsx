...
import { regTransferencia } from '../controllers/OperacionController'; // usa REST
...
export default function TransferenciaView() {
  ...
  const handleTransferencia = async () => {
    ...
    try {
      const mensaje = await regTransferencia(origen.trim(), destino.trim(), importe.trim());
      ...
      if (
        ...
        setEstadoTransaccion({
          exito: false,
          mensaje: mensaje || '❌ No se pudo completar la transferencia. Verifica los datos.'
        });
      }
    } catch (err) {
      setEstadoTransaccion({
